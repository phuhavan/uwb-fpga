...
static void initialize_c2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
static void initialize_params_c2_uwb_re_blackbox
  (SFc2_uwb_re_blackboxInstanceStruct *chartInstance);
static void enable_c2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
static void disable_c2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_uwb_re_blackbox
  (SFc2_uwb_re_blackboxInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_uwb_re_blackbox
  (SFc2_uwb_re_blackboxInstanceStruct *chartInstance);
static void set_sim_state_c2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct *
  chartInstance, const mxArray *c2_st);
static void finalize_c2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
static void sf_c2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
static void initSimStructsc2_uwb_re_blackbox(SFc2_uwb_re_blackboxInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance, const mxArray *c2_SYNC, const char_T *c2_identifier, int8_T
  c2_y[31744]);
static void c2_b_emlrt_marshallIn(SFc2_uwb_re_blackboxInstanceStruct
...
static const mxArray *c2_d_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_c_emlrt_marshallIn(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static void c2_check_forloop_overflow_error(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
static const mxArray *c2_e_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_d_emlrt_marshallIn(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_e_emlrt_marshallIn(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_uwb_re_blackbox, const char_T
  *c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_uwb_re_blackboxInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_uwb_re_blackbox = 0U;
}
  ...
  (SFc2_uwb_re_blackboxInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_uwb_re_blackbox;
  ...
  chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_uwb_re_blackbox = c2_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 1)),
     "is_active_c2_uwb_re_blackbox");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_uwb_re_blackbox(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_uwb_re_blackboxInstanceStruct *chartInstance;
  chartInstance = (SFc2_uwb_re_blackboxInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_uwb_re_blackbox_get_eml_resolved_functions_info(void)
{
  ...
  *c2_identifier)
{
  ...
  c2_y = c2_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_uwb_re_blackbox), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_uwb_re_blackbox);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_uwb_re_blackbox_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_uwb_re_blackbox_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c2_uwb_re_blackbox(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"SYNC\",},{M[8],M[0],T\"is_active_c2_uwb_re_blackbox\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_uwb_re_blackbox_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_uwb_re_blackboxInstanceStruct *chartInstance;
    chartInstance = (SFc2_uwb_re_blackboxInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_uwb_re_blackbox(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInstanceVar);
  initialize_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_uwb_re_blackbox(void *chartInstanceVar)
{
  enable_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_uwb_re_blackbox(void *chartInstanceVar)
{
  disable_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_uwb_re_blackbox(void *chartInstanceVar)
{
  sf_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_uwb_re_blackbox(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_uwb_re_blackbox
    ((SFc2_uwb_re_blackboxInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_uwb_re_blackbox();/* state var info */
...
extern void sf_internal_set_sim_state_c2_uwb_re_blackbox(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_uwb_re_blackbox(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_uwb_re_blackbox(S);
}

static void sf_opaque_set_sim_state_c2_uwb_re_blackbox(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_uwb_re_blackbox(S, st);
}

static void sf_opaque_terminate_c2_uwb_re_blackbox(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_uwb_re_blackboxInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_uwb_re_blackbox((SFc2_uwb_re_blackboxInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_uwb_re_blackbox(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_uwb_re_blackbox(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_uwb_re_blackbox(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_uwb_re_blackbox(SimStruct *S)
{
  SFc2_uwb_re_blackboxInstanceStruct *chartInstance;
  chartInstance = (SFc2_uwb_re_blackboxInstanceStruct *)malloc(sizeof
    (SFc2_uwb_re_blackboxInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_uwb_re_blackboxInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_uwb_re_blackbox;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_uwb_re_blackbox;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_uwb_re_blackbox;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_uwb_re_blackbox;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_uwb_re_blackbox;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_uwb_re_blackbox;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_uwb_re_blackbox;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_uwb_re_blackbox;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_uwb_re_blackbox;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_uwb_re_blackbox;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_uwb_re_blackbox;
...
void c2_uwb_re_blackbox_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_uwb_re_blackbox(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_uwb_re_blackbox(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_uwb_re_blackbox(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_uwb_re_blackbox_method_dispatcher.\n"
