...
static void initialize_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static void initialize_params_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static void enable_c3_uwb_hw_cosim_kintex(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance);
static void disable_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static void set_sim_state_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static void sf_c3_uwb_hw_cosim_kintex(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance);
static void initSimStructsc3_uwb_hw_cosim_kintex
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance, const mxArray *c3_SFD, const char_T *c3_identifier, int8_T
  c3_y[15872]);
static void c3_b_emlrt_marshallIn(SFc3_uwb_hw_cosim_kintexInstanceStruct
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_c_emlrt_marshallIn(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_uwb_hw_cosim_kintex, const
  char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_uwb_hw_cosim_kintexInstanceStruct
  *chartInstance);
  ...
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_uwb_hw_cosim_kintex = 0U;
}
  ...
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_uwb_hw_cosim_kintex;
  ...
  (SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  chartInstance->c3_is_active_c3_uwb_hw_cosim_kintex = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
     "is_active_c3_uwb_hw_cosim_kintex");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_uwb_hw_cosim_kintex(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance;
  chartInstance = (SFc3_uwb_hw_cosim_kintexInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_uwb_hw_cosim_kintex_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_uwb_hw_cosim_kintex), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_uwb_hw_cosim_kintex);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_uwb_hw_cosim_kintex_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_uwb_hw_cosim_kintex_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_uwb_hw_cosim_kintex(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[7],T\"SFD\",},{M[8],M[0],T\"is_active_c3_uwb_hw_cosim_kintex\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_uwb_hw_cosim_kintex_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance;
    chartInstance = (SFc3_uwb_hw_cosim_kintexInstanceStruct *) ((ChartInfoStruct
...
static void sf_opaque_initialize_c3_uwb_hw_cosim_kintex(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_uwb_hw_cosim_kintex
    ((SFc3_uwb_hw_cosim_kintexInstanceStruct*) chartInstanceVar);
  initialize_c3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_uwb_hw_cosim_kintex(void *chartInstanceVar)
{
  enable_c3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_uwb_hw_cosim_kintex(void *chartInstanceVar)
{
  disable_c3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_uwb_hw_cosim_kintex(void *chartInstanceVar)
{
  sf_c3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_uwb_hw_cosim_kintex(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_uwb_hw_cosim_kintex
    ((SFc3_uwb_hw_cosim_kintexInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_uwb_hw_cosim_kintex();/* state var info */
...
extern void sf_internal_set_sim_state_c3_uwb_hw_cosim_kintex(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_uwb_hw_cosim_kintex(SimStruct*
  S)
{
  return sf_internal_get_sim_state_c3_uwb_hw_cosim_kintex(S);
}

static void sf_opaque_set_sim_state_c3_uwb_hw_cosim_kintex(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_uwb_hw_cosim_kintex(S, st);
}

static void sf_opaque_terminate_c3_uwb_hw_cosim_kintex(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_uwb_hw_cosim_kintexInstanceStruct*) chartInstanceVar
      )->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_uwb_hw_cosim_kintex((SFc3_uwb_hw_cosim_kintexInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_uwb_hw_cosim_kintex(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c3_uwb_hw_cosim_kintex
      ((SFc3_uwb_hw_cosim_kintexInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_uwb_hw_cosim_kintex(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_uwb_hw_cosim_kintex(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_uwb_hw_cosim_kintex(SimStruct *S)
{
  SFc3_uwb_hw_cosim_kintexInstanceStruct *chartInstance;
  chartInstance = (SFc3_uwb_hw_cosim_kintexInstanceStruct *)malloc(sizeof
    (SFc3_uwb_hw_cosim_kintexInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_uwb_hw_cosim_kintexInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_uwb_hw_cosim_kintex;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_uwb_hw_cosim_kintex;
...
void c3_uwb_hw_cosim_kintex_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_uwb_hw_cosim_kintex(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_uwb_hw_cosim_kintex(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_uwb_hw_cosim_kintex(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_uwb_hw_cosim_kintex_method_dispatcher.\n"
